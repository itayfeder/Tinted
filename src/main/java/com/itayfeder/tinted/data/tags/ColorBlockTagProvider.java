...
public class ColorBlockTagProvider extends BlockTagsProvider {
    ...
    protected void addTags() {
        this.tag(BlockTags.WOOL).add(BlockInit.CORAL_WOOL.get(), BlockInit.BEIGE_WOOL.get(), BlockInit.OLIVE_WOOL.get(), BlockInit.TURQUOISE_WOOL.get(), BlockInit.AMBER_WOOL.get(), BlockInit.BUBBLEGUM_WOOL.get(), BlockInit.BORDEAUX_WOOL.get(), BlockInit.ENDER_WOOL.get(), BlockInit.MINT_WOOL.get(), BlockInit.INDIGO_WOOL.get(), BlockInit.OCHRE_WOOL.get(), BlockInit.LAVENDER_WOOL.get(), BlockInit.CHARTREUSE_WOOL.get());
        this.tag(BlockTags.WOOL_CARPETS).add(BlockInit.CORAL_CARPET.get(), BlockInit.BEIGE_CARPET.get(), BlockInit.OLIVE_CARPET.get(), BlockInit.TURQUOISE_CARPET.get(), BlockInit.AMBER_CARPET.get(), BlockInit.BUBBLEGUM_CARPET.get(), BlockInit.BORDEAUX_CARPET.get(), BlockInit.ENDER_CARPET.get(), BlockInit.MINT_CARPET.get(), BlockInit.INDIGO_CARPET.get(), BlockInit.OCHRE_CARPET.get(), BlockInit.LAVENDER_CARPET.get(), BlockInit.CHARTREUSE_CARPET.get());
        this.tag(BlockTags.BANNERS).add(BlockInit.CORAL_BANNER.get(), BlockInit.CORAL_WALL_BANNER.get(),
                ...
                BlockInit.INDIGO_BANNER.get(), BlockInit.INDIGO_WALL_BANNER.get(),
                BlockInit.OCHRE_BANNER.get(), BlockInit.OCHRE_WALL_BANNER.get(),
                BlockInit.LAVENDER_BANNER.get(), BlockInit.LAVENDER_WALL_BANNER.get(),
                BlockInit.CHARTREUSE_BANNER.get(), BlockInit.CHARTREUSE_WALL_BANNER.get());
        ...
        this.tag(BlockTags.BEDS).add(BlockInit.CORAL_BED.get(), BlockInit.BEIGE_BED.get(), BlockInit.OLIVE_BED.get(), BlockInit.TURQUOISE_BED.get(), BlockInit.AMBER_BED.get(), BlockInit.BUBBLEGUM_BED.get(), BlockInit.BORDEAUX_BED.get(), BlockInit.ENDER_BED.get(), BlockInit.MINT_BED.get(), BlockInit.INDIGO_BED.get(), BlockInit.OCHRE_BED.get(), BlockInit.LAVENDER_BED.get(), BlockInit.CHARTREUSE_BED.get());
        this.tag(BlockTags.SHULKER_BOXES).add(BlockInit.CORAL_SHULKER_BOX.get(), BlockInit.BEIGE_SHULKER_BOX.get(), BlockInit.OLIVE_SHULKER_BOX.get(), BlockInit.TURQUOISE_SHULKER_BOX.get(), BlockInit.AMBER_SHULKER_BOX.get(), BlockInit.BUBBLEGUM_SHULKER_BOX.get(), BlockInit.BORDEAUX_SHULKER_BOX.get(), BlockInit.ENDER_SHULKER_BOX.get(), BlockInit.MINT_SHULKER_BOX.get(), BlockInit.INDIGO_SHULKER_BOX.get(), BlockInit.OCHRE_SHULKER_BOX.get(), BlockInit.LAVENDER_SHULKER_BOX.get(), BlockInit.CHARTREUSE_SHULKER_BOX.get());
        this.tag(BlockTags.CANDLES).add(BlockInit.CORAL_CANDLE.get(), BlockInit.BEIGE_CANDLE.get(), BlockInit.OLIVE_CANDLE.get(), BlockInit.TURQUOISE_CANDLE.get(), BlockInit.AMBER_CANDLE.get(), BlockInit.BUBBLEGUM_CANDLE.get(), BlockInit.BORDEAUX_CANDLE.get(), BlockInit.ENDER_CANDLE.get(), BlockInit.MINT_CANDLE.get(), BlockInit.INDIGO_CANDLE.get(), BlockInit.OCHRE_CANDLE.get(), BlockInit.LAVENDER_CANDLE.get(), BlockInit.CHARTREUSE_CANDLE.get());
        this.tag(BlockTags.CANDLE_CAKES).add(BlockInit.CORAL_CANDLE_CAKE.get(), BlockInit.BEIGE_CANDLE_CAKE.get(), BlockInit.OLIVE_CANDLE_CAKE.get(), BlockInit.TURQUOISE_CANDLE_CAKE.get(), BlockInit.AMBER_CANDLE_CAKE.get(), BlockInit.BUBBLEGUM_CANDLE_CAKE.get(), BlockInit.BORDEAUX_CANDLE_CAKE.get(), BlockInit.ENDER_CANDLE_CAKE.get(), BlockInit.MINT_CANDLE_CAKE.get(), BlockInit.INDIGO_CANDLE_CAKE.get(), BlockInit.OCHRE_CANDLE_CAKE.get(), BlockInit.LAVENDER_CANDLE_CAKE.get(), BlockInit.CHARTREUSE_CANDLE_CAKE.get());
        this.tag(BlockTags.TERRACOTTA).add(BlockInit.CORAL_TERRACOTTA.get(), BlockInit.BEIGE_TERRACOTTA.get(), BlockInit.OLIVE_TERRACOTTA.get(), BlockInit.TURQUOISE_TERRACOTTA.get(), BlockInit.AMBER_TERRACOTTA.get(), BlockInit.BUBBLEGUM_TERRACOTTA.get(), BlockInit.BORDEAUX_TERRACOTTA.get(), BlockInit.ENDER_TERRACOTTA.get(), BlockInit.MINT_TERRACOTTA.get(), BlockInit.INDIGO_TERRACOTTA.get(), BlockInit.OCHRE_TERRACOTTA.get(), BlockInit.LAVENDER_TERRACOTTA.get(), BlockInit.CHARTREUSE_TERRACOTTA.get());
        ...
        this.tag(Tags.Blocks.STAINED_GLASS).add(BlockInit.CORAL_STAINED_GLASS.get(), BlockInit.BEIGE_STAINED_GLASS.get(), BlockInit.OLIVE_STAINED_GLASS.get(), BlockInit.TURQUOISE_STAINED_GLASS.get(), BlockInit.AMBER_STAINED_GLASS.get(), BlockInit.BUBBLEGUM_STAINED_GLASS.get(), BlockInit.BORDEAUX_STAINED_GLASS.get(), BlockInit.ENDER_STAINED_GLASS.get(), BlockInit.MINT_STAINED_GLASS.get(), BlockInit.INDIGO_STAINED_GLASS.get(), BlockInit.OCHRE_STAINED_GLASS.get(), BlockInit.LAVENDER_STAINED_GLASS.get(), BlockInit.CHARTREUSE_STAINED_GLASS.get());
        ...
        this.tag(Tags.Blocks.STAINED_GLASS_PANES).add(BlockInit.CORAL_STAINED_GLASS_PANE.get(), BlockInit.BEIGE_STAINED_GLASS_PANE.get(), BlockInit.OLIVE_STAINED_GLASS_PANE.get(), BlockInit.TURQUOISE_STAINED_GLASS_PANE.get(), BlockInit.AMBER_STAINED_GLASS_PANE.get(), BlockInit.BUBBLEGUM_STAINED_GLASS_PANE.get(), BlockInit.BORDEAUX_STAINED_GLASS_PANE.get(), BlockInit.ENDER_STAINED_GLASS_PANE.get(), BlockInit.MINT_STAINED_GLASS_PANE.get(), BlockInit.INDIGO_STAINED_GLASS_PANE.get(), BlockInit.OCHRE_STAINED_GLASS_PANE.get(), BlockInit.LAVENDER_STAINED_GLASS_PANE.get(), BlockInit.CHARTREUSE_STAINED_GLASS_PANE.get());
        ...
        this.tag(TintedBlockTags.CONCRETE).add(
                ...
                BlockInit.MINT_CONCRETE.get(), BlockInit.INDIGO_CONCRETE.get(), BlockInit.OCHRE_CONCRETE.get(), BlockInit.LAVENDER_CONCRETE.get(),
                BlockInit.CHARTREUSE_CONCRETE.get());
        this.tag(TintedBlockTags.CONCRETE_POWDER).add(
                ...
                BlockInit.MINT_CONCRETE_POWDER.get(), BlockInit.INDIGO_CONCRETE_POWDER.get(), BlockInit.OCHRE_CONCRETE_POWDER.get(), BlockInit.LAVENDER_CONCRETE_POWDER.get(),
                BlockInit.CHARTREUSE_CONCRETE_POWDER.get());
    }
}
